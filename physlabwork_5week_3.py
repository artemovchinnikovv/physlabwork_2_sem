...
x_data = all_data['delta P (Pa) (turbo)'].dropna().to_numpy()
x_name = "x_delta_press_Pa_turbo"
x_error = all_data['error delta P (turbo)'].dropna().to_numpy()
y_data = all_data['Q (m3/s) (turbo)'].dropna().to_numpy()
y_name = "y_flow_m3_div_s_turbo"
y_error = all_data['error Q (turbo)'].dropna().to_numpy()
...
#save
plt.savefig('physlabwork_3week_plot_3.svg')
