...
\begin{figure}[h!]
\begin{floatrow}
 \ffigbox[\FBwidth]{\caption{{\hyperlink{p4}{зависимость сопротивления от температуры}}}\label{fig:Graph_5}}%
...
\begin{figure}[h!]
\begin{floatrow}
 \ffigbox[\FBwidth]{\caption{{\hyperlink{p4}{зависимость коэффициента теплопроводности от температуры}}}\label{fig:Graph_5}}%
...
\begin{figure}[h!]
\begin{floatrow}
 \ffigbox[\FBwidth]{\caption{{{зависимость логарифма теплопроводности от логарифма температуры}}}\label{fig:Graph_5}}%
...
\begin{figure}[h!]
\begin{floatrow}
 \ffigbox[\FBwidth]{\caption{смешная картинка, чтобы не грустить от результата, далекого от табличного}\label{fig:Graph_5}}%
